...
// MongoDB connection
mongoose.connect('mongodb+srv://Dsouza:Nqtb2cS1ugkBtX7w@cluster0.bk52qvx.mongodb.net/paymentDB')
    .then(() => {
...
app.post('/checkPayment', async (req, res) => {
    ...
    const client = new MongoClient('mongodb+srv://Dsouza:Nqtb2cS1ugkBtX7w@cluster0.bk52qvx.mongodb.net/')
